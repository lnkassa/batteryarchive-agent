...
FROM (
  ...
  where cell_id IN ({{stack_id}}) and (cycle_index = {{cycle_1}} or cycle_index = {{cycle_2}} or cycle_index = {{cycle_3}}) and i>0
  group by 
    cell_id,
    cycle_time,
    v,
