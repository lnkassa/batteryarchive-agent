...
To install the batteryarchive-agent follow these steps (using a virtual environment is recommended):
...
1. Import li-ion cell sample data by running the following commands from the project root folder. Importing data may take a few minutes. Step 4 refreshes the queries so you can visualize them in redash.
    1.     cd scripts
